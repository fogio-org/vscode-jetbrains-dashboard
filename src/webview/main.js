...
(function () {
  ...
  var ICONS = {
    ...
    pin: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v5"/><path d="M5.5 7h5L11 9.5H5L5.5 7z"/><path d="M8 9.5V14"/><path d="M5 14h6"/></svg>',
    pinFilled: '<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v5"/><path d="M5.5 7h5L11 9.5H5L5.5 7z"/><path d="M8 9.5V14"/><path d="M5 14h6"/></svg>',
